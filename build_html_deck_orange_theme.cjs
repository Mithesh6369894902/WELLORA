...
let content = fs.readFileSync(path.join(__dirname, 'printable_slides_orange_theme.html'), 'utf8');
...
console.log('SUCCESS: Updated WELLORA_Slide_Deck.html with Orange Theme & White Text.');
