    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
        :root {
            --bg-page: #0B0F19;
            --bg-card: #121826;
            --bg-card-highlight: #172033;
            --bg-card-inner: #0A0D14;
            --orange-primary: #FF6B00;
            --orange-hover: #EA580C;
            --orange-subtle: rgba(255, 107, 0, 0.12);
            --orange-border: rgba(255, 107, 0, 0.45);
        ...
        .slide-accent-bar {
            ...
            right: 0;
            height: 6px;
            background: linear-gradient(90deg, var(--orange-primary), #FFA000, var(--orange-primary));
        }
        .slide-header {
            display: flex;
        ...
        .card-title.orange { color: #FF8C38; }
...
<body>
    ...
    <div class="slide">
        ...
        <div style="flex: 1; display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center; gap: 24px;">
            ...
            <h1 style="font-family: 'Space Grotesk', sans-serif; font-size: 76px; font-weight: 800; color: #FFFFFF; letter-spacing: -1.5px; line-height: 1.1;">
                WELLORA
            </h1>
            <h2 style="font-size: 32px; font-weight: 700; color: #F1F5F9; max-width: 1350px; line-height: 1.35;">
                Dual-Physics Digital Twin & Real-Time SCADA AI Optimization System for Heavy Crude Oil Fields (17.5° API)
            </h2>
            <p style="font-size: 19px; color: var(--text-muted); max-width: 1150px; line-height: 1.6;">
            ...
            <div style="display: flex; gap: 14px; flex-wrap: wrap; justify-content: center; margin-top: 10px;">
                <span class="pill" style="border-color: #38BDF8; color: #38BDF8; background: rgba(56, 189, 248, 0.1);">React 18 + TypeScript</span>
                <span class="pill" style="border-color: #FFA726; color: #FFA726; background: rgba(255, 167, 38, 0.1);">Thermal EOR ODE Solver</span>
                <span class="pill" style="border-color: #34D399; color: #34D399; background: rgba(52, 211, 153, 0.1);">2.0 Hz Real-Time SCADA</span>
                <span class="pill" style="border-color: var(--orange-primary); color: var(--orange-primary); background: rgba(255, 107, 0, 0.1);">Laser Tracing Dynamometer</span>
                <span class="pill" style="border-color: #C084FC; color: #C084FC; background: rgba(192, 132, 252, 0.1);">Conversational AI Copilot</span>
            </div>
            <div style="margin-top: 24px; padding: 16px 36px; background: var(--bg-card); border: 1.5px solid var(--border-card); border-radius: 12px; box-shadow: 0 4px 16px rgba(0,0,0,0.4); display: flex; gap: 48px; font-size: 16px;">
                <div><strong>Project Author:</strong> <span style="color: #FFFFFF;">Mithesh D</span></div>
                <div><strong>Domain:</strong> <span style="color: #FFA726;">Petroleum Digital Twin & SCADA Systems</span></div>
                <div><strong>Target Reservoir:</strong> <span style="color: #FFFFFF;">Heavy Crude (17.5° API, 3,500 cP)</span></div>
            </div>
        </div>
        <div class="slide-footer">
            <span>WELLORA Industrial Systems &bull; Project Presentation Deck</span>
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-2">
            <div class="card">
                <div class="card-title orange">Executive Problem Statement & Engineering Purpose</div>
                <ul class="point-list">
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-3">
            <div class="card">
                <div class="card-title orange">1. Fluid Composition & Gravity</div>
                <ul class="point-list">
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-3">
            <div class="card highlight">
                <div class="card-title orange">Stage 1: Steam Injection (Days 1 - 12)</div>
                <ul class="point-list">
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-2">
            <div class="card">
                <div class="card-title orange">Sucker Rod Pumping Unit Operation</div>
                <ul class="point-list">
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-2">
            <div class="card">
                <div class="card-title orange">1. Andrade Exponential Viscosity Model Calibration</div>
...
• Production (Day 19-90): T(t) = 45 + (T_steam - 70)·exp(-0.038·(t - 18))</div>
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-2">
            <div class="card">
                <div class="card-title orange">1. Sucker Rod Wave Equations (API RP 11L)</div>
...
4. Output Schema: { text: string, action?: ActionPayload }</div>
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-3">
            <div class="card">
                <div class="card-title orange">Tier 1: Subsurface Physics</div>
                <ul class="point-list">
            ...
            <div class="card">
                <div class="card-title orange">Multi-Well Field Matrix</div>
                <ul class="point-list">
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-2">
            <div class="card">
                <div class="card-title orange">Hardware Specifications</div>
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-3">
            <div class="card">
                <div class="card-title orange">1. Orange-Accented Industrial Palette</div>
                <ul class="point-list">
                    <li><strong>High-Contrast Industrial System:</strong> Clean dark slate (#0B0F19) canvas accented with precise Cyber-Orange (#FF6B00) tokens to maximize contrast and eliminate operator eye fatigue.</li>
                    <li><strong>Status Semantic Colors:</strong> Emerald Green (#34D399) for Normal, Amber (#FFA726) for Warning/Soaking, Crimson Red (#F87171) for Critical Alarms, and Cyan (#38BDF8) for Steam Injection.</li>
                </ul>
            </div>
            <div class="card highlight">
                <div class="card-title">2. Reactive Component Tree</div>
                <ul class="point-list">
                    <li><strong>App.tsx:</strong> Central telemetry coordinator synchronizing 2.0 Hz telemetry ticks, active well selection, and simulation parameters.</li>
                    <li><strong>Navbar.tsx:</strong> Multi-well field matrix switcher and 90-day CSS cycle stepper navigation bar.</li>
                    <li><strong>LiveOscilloscope.tsx:</strong> 2 Hz dual-channel live waveform plotter with phosphor decay.</li>
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-2-1">
            ...
            <div class="card highlight">
                <div class="card-title orange">Component Analysis & Walkthrough</div>
                <ul class="point-list">
            ...
            <div class="card">
                ...
                <ul class="point-list">
                    <li><strong>Dual-Channel Live Waveforms:</strong>
                        <br>&bull; <strong style="color: #FFA726;">Channel A (Orange Trace):</strong> Polish Rod Load (lbs) over time showing peak tension during upstroke and unloading on downstroke.
                        <br>&bull; <strong style="color: #38BDF8;">Channel B (Cyan Trace):</strong> Motor Current (Amperes) showing instantaneous electrical power demand.
                    </li>
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-2-1">
            ...
            <div class="card highlight">
                <div class="card-title orange">Dynamometer Analysis & Mechanical Diagnosis</div>
                <ul class="point-list">
                    ...
                    <li><strong>Surface vs Downhole Card Comparison:</strong>
                        <br>&bull; <strong style="color: #FFA726;">Outer Surface Card:</strong> Measured at the surface polish rod incorporating total string elastic stretch and inertia.
                        <br>&bull; <strong style="color: #34D399;">Inner Pump Card:</strong> Derived downhole pump card representing actual fluid displacement inside the working barrel.
                    </li>
...
<span class="code-keyword">export function</span> <span class="code-func">calculateCycleState</span>(<span class="code-var">dayOfCycle</span>: <span class="code-var">number</span>, <span class="code-var">steamTemp</span>: <span class="code-var">number</span> = <span class="code-num">260</span>) {
  <span class="code-keyword">if</span> (dayOfCycle &lt;= <span class="code-num">12</span>) {
    ...
    <span class="code-keyword">return</span> { stage: <span class="code-str">'PRODUCTION'</span>, temp, viscosity: <span class="code-func">calculateViscosity</span>(temp) };
            ...
            <div class="card highlight">
                <div class="card-title orange">Code Engineering Rationale</div>
                <ul class="point-list">
...
<span class="code-keyword">export async function</span> <span class="code-func">getAiCopilotResponse</span>(<span class="code-var">query</span>: <span class="code-var">string</span>, <span class="code-var">ctx</span>: <span class="code-var">WelloraState</span>): <span class="code-func">Promise</span>&lt;<span class="code-var">AiCopilotMessage</span>&gt; {
  ...
  <span class="code-keyword">return</span> <span class="code-func">generateTechnicalExplanation</span>(query, ctx);
            ...
            <div class="card">
                <div class="card-title orange">AI Engine Architecture</div>
                <ul class="point-list">
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-2-1">
            ...
            <div class="card highlight">
                <div class="card-title orange">Control Room Operations & Alarm Handling</div>
                <ul class="point-list">
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-2-1">
            ...
            <div class="card highlight">
                <div class="card-title orange">Closed-Loop Parameter Dispatching</div>
                <ul class="point-list">
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-2">
            <div class="card highlight">
                <div class="card-title orange">Key Technical Accomplishments</div>
                <ul class="point-list">
    ...
    <div class="slide">
        ...
        <div class="slide-body" style="grid-template-columns: 1fr; display: flex; flex-direction: column; gap: 14px;">
            <div class="card" style="flex-direction: row; align-items: center; gap: 24px; padding: 18px 24px;">
                ...
                <div>
                    <div class="card-title orange" style="font-size: 18px;">1. Edge IoT RTU Hardware Bridge (MQTT Sparkplug B & OPC-UA)</div>
            ...
            <div class="card" style="flex-direction: row; align-items: center; gap: 24px; padding: 18px 24px;">
                <div style="font-size: 34px;">📱</div>
                <div>
                    <div class="card-title orange" style="font-size: 18px;">4. Native Android APK & Cross-Platform Field App</div>
...
const htmlPath = path.join(__dirname, 'printable_slides_tasteful_orange.html');
fs.writeFileSync(htmlPath, htmlContent);
console.log('Saved printable_slides_tasteful_orange.html');
...
console.log('Rendering tasteful orange accent PDF...');

try {
    execSync(cmd, { stdio: 'inherit' });
    console.log('SUCCESS: Generated Tasteful Orange Accent PDF at:', pdfPath);
} catch (e) {
