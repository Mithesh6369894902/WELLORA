...
let content = fs.readFileSync(path.join(__dirname, 'printable_slides_orange_white.html'), 'utf8');

// Inject interactive CSS and JS into WELLORA_Slide_Deck.html
...
<div class="nav-bar">
    ...
    <button class="nav-btn" onclick="toggleFullScreen()" style="background: #0284C7; color: #FFF; border-color: #0284C7;">⛶ Fullscreen</button>
</div>
...
console.log('SUCCESS: Updated WELLORA_Slide_Deck.html with 24-slide Orange-White interactive presentation.');
