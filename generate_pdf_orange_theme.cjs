...
<head>
    <meta charset="UTF-8">
    <title>WELLORA - Dual-Physics Digital Twin & SCADA AI Optimization System (Orange Theme)</title>
    <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&family=JetBrains+Mono:wght@400;500;600;700&family=Space+Grotesk:wght@500;600;700;800&display=swap" rel="stylesheet">
    <style>
        @page {
            size: 1920px 1080px;
            margin: 0;
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
        :root {
            --bg-page: #C2410C;
            --bg-gradient: linear-gradient(135deg, #9A3412 0%, #C2410C 45%, #EA580C 100%);
            --bg-card: rgba(67, 20, 7, 0.65);
            --bg-card-highlight: rgba(124, 45, 18, 0.85);
            --bg-card-inner: rgba(45, 13, 5, 0.7);
            ...
            --text-body: #FFF7ED;
            --text-muted: #FFD8A8;
            --border-card: rgba(255, 255, 255, 0.28);
        ...
        .slide-accent-bar {
            ...
            right: 0;
            height: 10px;
            background: linear-gradient(90deg, #FFFFFF, #FDE047, #FFA000, #FFFFFF);
        }
        .slide-header {
            display: flex;
        ...
        .slide-header::after {
            ...
            width: 260px;
            height: 4px;
            background: linear-gradient(90deg, #FFFFFF, #FDE047, transparent);
            border-radius: 2px;
        }
        .pill {
            display: inline-flex;
        ...
        .card-title.yellow { color: var(--yellow-accent); }
        .card-title.cyan { color: var(--cyan-accent); }
        .card-title.green { color: var(--green-accent); }
        ...
        .code-keyword { color: #F87171; font-weight: bold; }
        .code-func { color: #C084FC; font-weight: 600; }
        .code-var { color: #67E8F9; }
        .code-str { color: #86EFAC; }
        .code-num { color: #FDE047; font-weight: bold; }
        .code-comment { color: #9CA3AF; font-style: italic; }

        .img-card {
            background: rgba(20, 5, 1, 0.6);
...
<body>
    ...
    <div class="slide">
        ...
        <div style="flex: 1; display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center; gap: 24px;">
            ...
            <h1 style="font-family: 'Space Grotesk', sans-serif; font-size: 78px; font-weight: 800; color: #FFFFFF; letter-spacing: -1.5px; line-height: 1.1; text-shadow: 0 4px 18px rgba(0,0,0,0.4);">
                WELLORA
            </h1>
            <h2 style="font-size: 32px; font-weight: 700; color: #FFF7ED; max-width: 1350px; line-height: 1.35; text-shadow: 0 2px 8px rgba(0,0,0,0.3);">
                Dual-Physics Digital Twin & Real-Time SCADA AI Optimization System for Heavy Crude Oil Fields (17.5° API)
            </h2>
            <p style="font-size: 19px; color: #FED7AA; max-width: 1150px; line-height: 1.6;">
            ...
            <div style="display: flex; gap: 14px; flex-wrap: wrap; justify-content: center; margin-top: 10px;">
                <span class="pill">React 18 + TypeScript</span>
                <span class="pill" style="border-color: var(--yellow-accent); color: var(--yellow-accent);">Thermal EOR ODE Solver</span>
                <span class="pill" style="border-color: var(--green-accent); color: var(--green-accent);">2.0 Hz Real-Time SCADA</span>
                <span class="pill" style="border-color: var(--cyan-accent); color: var(--cyan-accent);">Laser Tracing Dynamometer</span>
                <span class="pill">Conversational AI Copilot</span>
            </div>
            <div style="margin-top: 24px; padding: 18px 40px; background: rgba(45, 12, 3, 0.7); border: 2px solid rgba(255, 255, 255, 0.4); border-radius: 14px; box-shadow: 0 8px 24px rgba(0,0,0,0.3); display: flex; gap: 48px; font-size: 16px; color: #FFFFFF;">
        ...
        <div class="slide-footer">
            <span>WELLORA Industrial Systems &bull; Orange Theme Presentation Deck</span>
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-2">
            <div class="card">
                <div class="card-title yellow">Executive Problem Statement & Engineering Purpose</div>
                <ul class="point-list">
                    <li><strong>The Heavy Crude Challenge (17.5° API):</strong> Heavy oil extraction suffers from severe flow resistance because cold reservoir oil exhibits near-solid tar viscosity (>3,500 cP at 28°C), causing extreme rod string friction, pump floating, and premature motor burnout.</li>
            ...
            <div class="card highlight">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-top: 8px;">
                    <div class="kpi-card">
                        ...
                        <div style="font-size: 12px; color: #FFD8A8; margin-top: 4px;">Optimized soak duration minimizes formation heat waste</div>
                    </div>
                    <div class="kpi-card">
                        <div class="kpi-val">-34.8%</div>
                        <div class="kpi-label">Rod String Fatigue</div>
                        <div style="font-size: 12px; color: #FFD8A8; margin-top: 4px;">Dynamic speed throttling prevents fluid pound & rod stress</div>
                    </div>
                    <div class="kpi-card">
                        <div class="kpi-val">2.0 Hz</div>
                        <div class="kpi-label">Telemetry Sampling</div>
                        <div style="font-size: 12px; color: #FFD8A8; margin-top: 4px;">Sub-second sensor stream with Web Audio alarms</div>
                    </div>
                    <div class="kpi-card">
                        <div class="kpi-val">100%</div>
                        <div class="kpi-label">Closed-Loop AI Dispatch</div>
                        <div style="font-size: 12px; color: #FFD8A8; margin-top: 4px;">Direct parameter execution without manual recalculation</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-3">
            <div class="card">
                <div class="card-title yellow">1. Fluid Composition & Gravity</div>
                <ul class="point-list">
            ...
            <div class="card">
                <div class="card-title cyan">2. Flow Dynamics in Porous Rock</div>
                <ul class="point-list">
            ...
            <div class="card">
                <div class="card-title green">3. Production Challenges</div>
                <ul class="point-list">
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-3">
            <div class="card highlight">
                <div class="card-title yellow">Stage 1: Steam Injection (Days 1 - 12)</div>
                <ul class="point-list">
            ...
            <div class="card">
                <div class="card-title cyan">Stage 2: Formation Soaking (Days 13 - 18)</div>
                <ul class="point-list">
            ...
            <div class="card">
                <div class="card-title green">Stage 3: Production Drawdown (Days 19 - 90)</div>
                <ul class="point-list">
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-2">
            <div class="card">
                <div class="card-title yellow">Sucker Rod Pumping Unit Operation</div>
                <ul class="point-list">
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-2">
            <div class="card">
                <div class="card-title yellow">1. Andrade Exponential Viscosity Model Calibration</div>
...
• T = 260°C (Steam Injected) => μ = 12.8 cP</div>
            ...
            <div class="card">
                <div class="card-title cyan">2. 90-Day Formation Thermal Dissipation ODE</div>
...
• Production (Day 19-90): T(t) = 45 + (T_steam - 70)·exp(-0.038·(t - 18))</div>
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-2">
            <div class="card">
                <div class="card-title yellow">1. Sucker Rod Wave Equations (API RP 11L)</div>
...
4. Output Schema: { text: string, action?: ActionPayload }</div>
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-3">
            <div class="card">
                <div class="card-title yellow">Tier 1: Subsurface Physics</div>
                <ul class="point-list">
            ...
            <div class="card">
                <div class="card-title cyan">Tier 3: Sucker Rod Kinematics</div>
                <ul class="point-list">
            ...
            <div class="card">
                <div class="card-title green">Tier 4: SCADA Visualizers</div>
                <ul class="point-list">
            ...
            <div class="card">
                <div class="card-title yellow">Multi-Well Field Matrix</div>
                <ul class="point-list">
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-2">
            <div class="card">
                <div class="card-title yellow">Hardware Specifications</div>
            ...
            <div class="card highlight">
                ...
                <table class="table-custom">
                    ...
                    <tr><td><strong>UI Design System</strong></td><td>Tailwind CSS + Custom Orange Theme</td><td>Cyber-Orange SCADA theme, high-contrast industrial readability</td></tr>
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-3">
            <div class="card">
                <div class="card-title yellow">1. Industrial Orange Palette & Tokens</div>
                <ul class="point-list">
                    <li><strong>High-Contrast Industrial System:</strong> Energetic industrial orange theme (#C2410C) paired with pure white text (#FFFFFF) to guarantee readability in 24/7 control rooms.</li>
                    <li><strong>Status Semantic Colors:</strong> Emerald Green (#4ADE80) for Normal, Yellow (#FDE047) for Warning, Crimson Red (#F87171) for Critical Alarms, and Cyan (#67E8F9) for Steam Injection.</li>
                </ul>
            </div>
            <div class="card highlight">
            ...
            <div class="card">
                <div class="card-title cyan">3. UX Micro-Interactions</div>
                <ul class="point-list">
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-2-1">
            ...
            <div class="card highlight">
                <div class="card-title yellow">Component Analysis & Walkthrough</div>
                <ul class="point-list">
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-2-1">
            ...
            <div class="card">
                <div class="card-title cyan">Signal Processing & Oscilloscope Features</div>
                <ul class="point-list">
                    <li><strong>Dual-Channel Live Waveforms:</strong>
                        <br>&bull; <strong style="color: #FDE047;">Channel A (Orange Trace):</strong> Polish Rod Load (lbs) over time showing peak tension during upstroke and unloading on downstroke.
                        <br>&bull; <strong style="color: #67E8F9;">Channel B (Cyan Trace):</strong> Motor Current (Amperes) showing instantaneous electrical power demand.
                    </li>
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-2-1">
            ...
            <div class="card highlight">
                <div class="card-title yellow">Dynamometer Analysis & Mechanical Diagnosis</div>
                <ul class="point-list">
                    ...
                    <li><strong>Surface vs Downhole Card Comparison:</strong>
                        <br>&bull; <strong style="color: #FDE047;">Outer Surface Card:</strong> Measured at the surface polish rod incorporating total string elastic stretch and inertia.
                        <br>&bull; <strong style="color: #4ADE80;">Inner Pump Card:</strong> Derived downhole pump card representing actual fluid displacement inside the working barrel.
                    </li>
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-2-1">
            ...
            <div class="card">
                <div class="card-title green">Synoptic Flow Architecture & 3D Visualizer</div>
                <ul class="point-list">
...
<span class="code-keyword">export function</span> <span class="code-func">calculateCycleState</span>(<span class="code-var">dayOfCycle</span>: <span class="code-var">number</span>, <span class="code-var">steamTemp</span>: <span class="code-var">number</span> = <span class="code-num">260</span>) {
  <span class="code-keyword">if</span> (dayOfCycle &lt;= <span class="code-num">12</span>) {
    ...
    <span class="code-keyword">return</span> { stage: <span class="code-str">'PRODUCTION'</span>, temp, viscosity: <span class="code-func">calculateViscosity</span>(temp) };
            ...
            <div class="card highlight">
                <div class="card-title yellow">Code Engineering Rationale</div>
                <ul class="point-list">
...
<span class="code-keyword">export function</span> <span class="code-func">calculateSRPMechanics</span>(
  ...
  <span class="code-keyword">return</span> { pprl: Math.<span class="code-func">round</span>(pprl), mprl: Math.<span class="code-func">round</span>(mprl), rodStressPsi: Math.<span class="code-func">round</span>(rodStressPsi), motorHPEstimate };
            ...
            <div class="card">
                <div class="card-title cyan">Mechanical Algorithm Highlights</div>
                <ul class="point-list">
...
<span class="code-keyword">export function</span> <span class="code-func">startTelemetryStream</span>(<span class="code-var">onData</span>: (<span class="code-var">snapshot</span>: <span class="code-var">ScadaSnapshot</span>) => <span class="code-var">void</span>) {
  ...
  <span class="code-keyword">return</span> () => clearInterval(interval);
            ...
            <div class="card highlight">
                <div class="card-title green">Telemetry Engine Highlights</div>
                <ul class="point-list">
...
<span class="code-keyword">export async function</span> <span class="code-func">getAiCopilotResponse</span>(<span class="code-var">query</span>: <span class="code-var">string</span>, <span class="code-var">ctx</span>: <span class="code-var">WelloraState</span>): <span class="code-func">Promise</span>&lt;<span class="code-var">AiCopilotMessage</span>&gt; {
  ...
  <span class="code-keyword">return</span> <span class="code-func">generateTechnicalExplanation</span>(query, ctx);
            ...
            <div class="card">
                <div class="card-title yellow">AI Engine Architecture</div>
                <ul class="point-list">
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-2-1">
            ...
            <div class="card highlight">
                <div class="card-title yellow">Control Room Operations & Alarm Handling</div>
                <ul class="point-list">
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-2-1">
            ...
            <div class="card">
                <div class="card-title cyan">Conversational Copilot in Action</div>
                <ul class="point-list">
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-2-1">
            ...
            <div class="card highlight">
                <div class="card-title yellow">Closed-Loop Parameter Dispatching</div>
                <ul class="point-list">
    ...
    <div class="slide">
        ...
        <div class="slide-body grid-2">
            <div class="card highlight">
                <div class="card-title yellow">Key Technical Accomplishments</div>
                <ul class="point-list">
    ...
    <div class="slide">
        ...
        <div class="slide-body" style="grid-template-columns: 1fr; display: flex; flex-direction: column; gap: 14px;">
            <div class="card" style="flex-direction: row; align-items: center; gap: 24px; padding: 18px 24px;">
                ...
                <div>
                    <div class="card-title yellow" style="font-size: 18px;">1. Edge IoT RTU Hardware Bridge (MQTT Sparkplug B & OPC-UA)</div>
                    <div style="font-size: 14.5px; color: #FFF7ED; margin-top: 4px;">Direct physical coupling with field Modbus TCP RTUs, MQTT brokers, and Siemens/Rockwell PLCs for live field wellhead sensor data ingestion.</div>
                </div>
            </div>
            <div class="card" style="flex-direction: row; align-items: center; gap: 24px; padding: 18px 24px;">
                <div style="font-size: 34px;">🧠</div>
                <div>
                    <div class="card-title cyan" style="font-size: 18px;">2. Physics-Informed Neural Networks (PINN)</div>
                    <div style="font-size: 14.5px; color: #FFF7ED; margin-top: 4px;">Embedding deep learning PINN surrogate models to solve 3D reservoir thermal diffusion equations in sub-milliseconds on edge AI accelerators.</div>
                </div>
            </div>
            <div class="card highlight" style="flex-direction: row; align-items: center; gap: 24px; padding: 18px 24px;">
                <div style="font-size: 34px;">🔄</div>
                <div>
                    <div class="card-title green" style="font-size: 18px;">3. Autonomous Closed-Loop VFD Motor Modulation</div>
                    <div style="font-size: 14.5px; color: #FFF7ED; margin-top: 4px;">Enabling autonomous Variable Frequency Drive (VFD) speed modulation, automatically throttling pump SPM upon detecting fluid pound or gas lock.</div>
                </div>
            </div>
            <div class="card" style="flex-direction: row; align-items: center; gap: 24px; padding: 18px 24px;">
                <div style="font-size: 34px;">📱</div>
                <div>
                    <div class="card-title yellow" style="font-size: 18px;">4. Native Android APK & Cross-Platform Field App</div>
                    <div style="font-size: 14.5px; color: #FFF7ED; margin-top: 4px;">Packaging WELLORA into a native Android APK and iOS field application with push notifications for critical downhole pressure drop and rod stress alarms.</div>
                </div>
            </div>
        </div>
        <div class="slide-footer">
...
const htmlPath = path.join(__dirname, 'printable_slides_orange_theme.html');
fs.writeFileSync(htmlPath, htmlContent);
console.log('Saved printable_slides_orange_theme.html');
...
console.log('Running Edge print-to-pdf command for Orange Theme with White Text...');

try {
    execSync(cmd, { stdio: 'inherit' });
    console.log('SUCCESS: Generated Orange Theme (White Text) PDF at:', pdfPath);
} catch (e) {
